...
Person = namedtuple('PersonTuppleNameSpeciallyForRafal', '')
...
class Test(unittest.TestCase):
    ...
    def test_person(self):
        ...
        '''
        person = Person('Przemek', 26)
        self.assertEqual('Przemek', person[0])
        self.assertEqual(26, person[1])
        
    def test_default_dict(self):
        '''
        try to meet this requirement without assignment,
        take a look at defaultdict() constructor
        '''
